...
\begin{table*}[]
    \resizebox{\linewidth}{!}{%
        \begin{tabular}{@{}lcccccccc@{}}
            \toprule
            \textbf{Distance Measure} & \textbf{Simple} & \textbf{Unfiltered} & \textbf{Effect Size} & \textbf{Description} & \textbf{Labels} & \textbf{Refinements} & \textbf{Position} & \textbf{Metric} \\ \midrule
            \textbf{Statistics}       &                 & \Checkmark          & \footnotemark        & \Checkmark           &                 & \Checkmark           &                   &                 \\
            \textbf{TED}              & \Checkmark      & \Checkmark          & \Checkmark           & \Checkmark           & \Checkmark      & \Checkmark           & \Checkmark        & \Checkmark      \\
            \textbf{LD}               & \Checkmark      & \Checkmark          & \Checkmark           &                      & \Checkmark      &                      &                   & \Checkmark      \\
            \textbf{RD}               & \Checkmark      & \Checkmark          & \Checkmark           & \Checkmark           & \Checkmark      & \Checkmark           & \footnotemark     & \Checkmark      \\
            \textbf{MSD}              & \Checkmark      & \Checkmark          &                      &                      & \Checkmark      &                      &                   &                 \\ \bottomrule
        \end{tabular}
    }
\end{table*}
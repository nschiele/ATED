...
\textbf{LD}               & \Confirm      & \Confirm          & \Confirm           & \Partial \footnotemark[1]                    &\Confirm   & \Confirm      & \Negate                      & \Negate                   & \Confirm      \\
\textbf{RD}               & \Confirm      & \Confirm          & \Confirm           & \Confirm          &\Confirm   & \Confirm      & \Confirm           & \Partial \footnotemark[2]     & \Confirm      \\
\textbf{MSD}              & \Confirm      & \Confirm          & \Negate\footnotemark[3]                       &  \Partial  \footnotemark[1]                  &\Confirm   & \Confirm      & \Negate                      & \Negate                   & \Confirm                 \\ \bottomrule
            \end{tabular}
    }
...
1: These measures exclude significant information, as such their edit descriptions do not offer fully suitable descriptions of difference.\\% This requirement is partially met.\\
2: Radical distance incorporates the position of nodes w.r.t. their parent, however, it does not incorporate the position of the radical within the whole attack tree.  %This requirement is partially met.
%3: Multiset distance only measures the leaf nodes, which is unable to consider the magnitude of the distance between two trees.
        \normalsize}

...
Threat models are a recommended tool for threat analysis~\NS{TODO: cite anderson and schneier}. However, once these models are created, they may only be applicable to the analyst or the team of analysts that created them. Unlike other sources of threat intelligence, such as YARA Rules \NS{TODO: Cite something for this}, there is no means to share attack trees in this format.
